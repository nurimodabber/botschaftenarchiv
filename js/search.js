...
window.performSearch = function() {
    ...
    if (sortValue === 'date-desc') {
        ...
        results.sort((a, b) => {
            const rankA = a.item.canonicalRank != null ? a.item.canonicalRank : 55;
            const rankB = b.item.canonicalRank != null ? b.item.canonicalRank : 55;
            const scoreA = (a.score || 0) + (rankA / 80);
            const scoreB = (b.score || 0) + (rankB / 80);
