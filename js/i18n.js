...
window.I18n = (function() {
    ...
    const TRANSLATIONS = {
        de: {
            ...
            'nav.books': 'Bücher',
            'nav.books_title': 'Heilige Schriften & Bücher',
            ...
            'settings.accent_custom_title': 'Eigene Farbe wählen (Farbrad öffnen)',
            'settings.color_wheel_title': 'Farbrad & Eigene Farbe',
            'settings.color_wheel_lightness': 'Helligkeit',
            'settings.color_wheel_apply': 'Übernehmen',
            'settings.color_wheel_cancel': 'Schließen',
            'settings.color_wheel_presets': 'Harmonische Töne:',
        ...
        en: {
            ...
            'nav.books': 'Books',
            'nav.books_title': 'Sacred Writings & Books',
            ...
            'settings.accent_terra_title': 'Terracotta',
            'settings.accent_custom_title': 'Choose custom color (Open color wheel)',
            'settings.color_wheel_title': 'Color Wheel & Custom Color',
            'settings.color_wheel_lightness': 'Brightness',
            'settings.color_wheel_apply': 'Apply',
            'settings.color_wheel_cancel': 'Close',
            'settings.color_wheel_presets': 'Harmonious tones:',
