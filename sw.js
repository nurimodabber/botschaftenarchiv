const CACHE_NAME = 'bahai-bib-v4.2';
const SHELL_ASSETS = [
  '/',
  '/index.html',
  ...
  '/js/i18n.js?v=4.2',
  '/js/i18n.js',
  '/js/settings.js?v=4.2',
  '/js/settings.js',
  '/js/filters.js?v=4.2',
  '/js/filters.js',
  '/js/search_engine.js?v=4.2',
  '/js/search_engine.js',
  '/js/viewer.js?v=4.2',
  '/js/viewer.js',
  '/js/collections.js?v=4.2',
  '/js/collections.js',
  '/js/compilation_builder.js?v=4.2',
  '/js/compilation_builder.js',
  '/js/timeline_data.js?v=4.2',
  '/js/timeline_data.js',
  '/js/timeline.js?v=4.2',
  '/js/timeline.js',
  '/js/books.js?v=4.2',
  '/js/books.js',
  '/js/sources.js?v=4.2',
